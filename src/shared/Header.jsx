...
const Header = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      if (currentScroll < lastScroll) setShowHeader(true)
  ...
  return (
    <AnimatePresence>
      {showHeader && (
        <motion.div
          className="flex items-center justify-between py-5 max-w-[1370px] w-full mx-auto relative z-50 bg-transparent"
        ...
        >
          <motion.a
            href="/"
            className="hover:scale-125 transition-all duration-300 hover:rotate-1 min-h-11"
          >
            <img src="/logo.png" alt="Logo" />
          </motion.a>

          <motion.nav className="hidden sm:flex gap-1 mx-auto">
